        ...
        <>
            <section className="presentation" id='presentation' aria-label="section de présentation">
                ...
                <p className="presentation-description">
                    ...
                    Objectif : Monter en compétences et m'épanouir en développant des applications mobiles et bureautiques. ANGULAR, PYTHON, C#, SWIFT et KOTLIN n'auront bientôt plus de secrets pour moi. Sans compter une évolution sur ma capacité à gérer un projet et les softs skills 
