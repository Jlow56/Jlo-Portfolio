            ...
            <section className="home" id="home" aria-label="section accueil du portfolio">
                <div className="home-left-container">
                    ...
                    <div className="cta-cv">
                        <a href="https://www.canva.com/design/DAGqKlUtoVM/wUEr2yShM9iPqwnYsXkBHA/edit?utm_content=DAGqKlUtoVM&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton" className="btn btn-cv" target="_blank" rel="noopener noreferrer">
